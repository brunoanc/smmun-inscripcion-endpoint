...
def registrar(background_tasks: BackgroundTasks, session: SessionDep, data: DelegacionFormData = Depends(), comprobante: UploadFile = File(...)):
    ...
    inscripcion = DelegacionSM(
        ...
        matricula=int(cast(str, data.matricula_0)) if data.matricula_0 is not None else None,
        ...
        matricula_co=int(cast(str, data.matricula_1)) if es_codelegacion and data.matricula_1 is not None else None,
